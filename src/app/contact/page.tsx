...
export default function ContactPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await emailjs.send(
                "service_pkx0dqx", // ✅ your Service ID
                "template_g5ldgp3", // ✅ visitor auto-reply template ID
                {
                    from_name: formData.name,
                    email: formData.email,
                    message: formData.message,
                },
                "cP3tNGpjyqDDOe_Yk" // ✅ your Public Key
            );

            // 2. Notification email to YOU (owner)
            await emailjs.send(
                "service_pkx0dqx", // same service
                "template_z41t5pm", // 🔥 create a new template in EmailJS for owner notifications
                {
